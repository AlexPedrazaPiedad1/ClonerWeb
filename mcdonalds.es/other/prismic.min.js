!(function (e) {
  ...
  1: function (e, t, n) {
    ...
    const i = (...e) =>
      ...
      a = (e) => Boolean(e && "object" == typeof e && e.constructor === Object),
      s =
        (e = "") =>
        (t = {}) =>
          "function" == typeof t[e] ? t[e]() : t[e] || t._ || null,
      c = ({ url: e, ...t }) => fetch(e, t).then((e) => e.json()),
      u = (e, t) => (e.length > t ? e.substring(0, t - 1) + "…" : e),
      d = async () => ("complete" !== document.readyState && (await l(0)), !0),
      ...
      g = (e) =>
        navigator.clipboard ? navigator.clipboard.writeText(e) : b(e),
      b = (e) => {
      ...
      y = (e, t) => {
        ...
        return function () {
          const o = Date.now() - r,
            a = o >= t,
            s = () => {
              ((r = Date.now()), (i = e.apply(this, arguments)));
            };
          return (clearTimeout(n), a ? s() : (n = setTimeout(s, t - o)), i);
        };
      },
      k = (e, t) => {
        const n = new Map();
        return function (...i) {
          ...
          return (n.has(r) || n.set(r, e(...i)), n.get(r));
        };
      },
      P = (e) => {
        let t, n;
      ...
      C = (e) => {
        ...
        Object.entries(e).forEach(([e, n]) =>
          "style" === e ? Object.assign(t.style, n) : t.setAttribute(e, n),
        );
        const n =
          document.head.attachShadow && t.attachShadow({ mode: "open" });
        return (document.body.appendChild(t), n || t);
      },
      O = (e) => {
  ...
  12: function (e, t, n) {
    ...
    const i = {
      ...
      r = (e, t = null) =>
        window.dispatchEvent(new CustomEvent(e, { detail: t, cancelable: !0 }));
  },
  14: function (e, t, n) {
    "use strict";
    var i = n(0);
    ...
    const o = {
        getCurrent: Object(i.throttle)(async () => {
          const e = await s.get(),
            ...
            n = await Object(i.fetchy)({ url: `/previews/${r}/ping?ref=${t}` });
          return (
            "object" == typeof e.preview && ((e.preview.ref = n.ref), s.set(e)),
            n
          );
        }, 2e3),
      },
      a = {
        run: Object(i.memoize)(
          async (e, t) => {
            const n = e.pathname.slice(1) + e.hash + r + ".jpg",
              i = await a.getSession({ location: e, imageName: n });
            return (i.hasPreviewImage || a.uploadScreenshot(n, t), i.url);
          },
          ({ href: e }) => e,
        ),
        async getSession({ location: e, imageName: t }) {
          ...
          return Object(i.fetchy)({ url: `/previews/s?${o}`, method: "POST" });
        },
        async uploadScreenshot(e, t) {
          const n = await Object(i.fetchy)({ url: `/previews/${r}/acl` }),
            o = new FormData();
          return (
            o.append("key", `${n.directory}/${e}`),
            ...
            o.append("file", t),
            fetch(n.url, { method: "POST", body: o })
          );
        },
      },
      s = {
        liveStateNeeded:
          Boolean(Object(i.getCookie)("is-logged-in")) ||
          Boolean(Object(i.getCookie)("io.prismic.previewSession")),
        state: null,
        get: async () => (s.state || (await s.insert()), s.state),
        set: (e = {}) => {
          s.state = e;
        },
        setNormalized: (e = {}) => {
        ...
        insert: async () => {
          s.liveStateNeeded
            ? s.setNormalized(await Object(i.fetchy)({ url: "/toolbar/state" }))
            : s.setNormalized();
        },
        normalize: (e = {}) =>
          Object.assign(
            ...
            e.previewState
              ? {
                  preview: {
                    ...
                    documents: []
                      .concat(e.previewState.draftPreview)
                      .concat(e.previewState.releasePreview)
                      .filter(Boolean),
                  },
                }
              : {},
  ...
  19: function (e, t, n) {
      ...
      constructor() {
        (i(
          ...
          (e, t) => (
            ...
            this.hooks.push({ type: e, callback: t }),
            t
          ),
        ),
          i(this, "off", (e, t) => {
            e && t
              ? this._removeHook(e, t)
              : e
                ? this._removeType(e)
                : this._removeAll();
          }),
      ...
      _removeHook(e, t) {
        (window.removeEventListener(e, t),
          (this.hooks = this.hooks.filter(
            (n) => !(n.type === e && n.callback === t),
          )));
      }
      _removeType(e) {
        (this.hooks
          .filter((t) => t.type === e)
          .forEach((t) => window.removeEventListener(e, t.callback)),
    ...
    window.fetch = async (...e) => {
      if (e[1] && !1 === e[1].emitEvents) return a(...e);
      o("beforeRequest", e);
      const t = await a(...e);
      return (o("afterRequest", e), t);
    };
    const s = function (e) {
      const t = window.history[e];
      return function () {
        const e = t.apply(this, arguments),
          n = new CustomEvent("historyChange", { detail: arguments });
        return (window.dispatchEvent(n), e);
      };
    };
    ((window.history.pushState = s("pushState")),
      (window.history.replaceState = s("replaceState")),
  ...
  20: function (e, t, n) {
    ...
    class i {
      constructor(e) {
        ((this.data = e), (this.filters = []));
      }
      addFilter(e, t) {
        return (this.filters.push({ computeValues: e, compare: t }), this);
      }
      compareData() {
        const e = this.filters.map((e) => e.computeValues(this.data));
        return ((t = e), t[0].map((e, n) => t.map((e) => e[n]))).map(
          (e, t) => ({ nodes: e, index: t }),
        );
        var t;
      }
      compareFunction() {
        ...
        return function (t, n) {
          ...
          for (let r = 0; r < e.length; r += 1) {
            const { didFirstWin: o, tie: a } = e[r](t.nodes[r], n.nodes[r]);
            a || (i = o ? -1 : 1);
          }
          return i;
        };
      ...
      is(e) {
        return this.addFilter(
          (t) => t.map((t) => Boolean(e(t))),
          (e, t) => ({ didFirstWin: e, tie: e === t }),
        );
      }
      isNot(e) {
        return this.addFilter(
      ...
      missing(e, t) {
        return this.addFilter(
          (n) => n.map((n) => Boolean(e(n).match(t))),
          (e, t) => ({ didFirstWin: e, tie: e === t }),
        );
      }
      in(e, t) {
        return this.addFilter(
          (n) => n.map((n) => Boolean(t.match(e(n)))),
          (e, t) => ({ didFirstWin: e, tie: e === t }),
        );
      }
      fuzzy(e, t, n) {
        return this.addFilter(
          (i) => {
            ...
            return r
              .map((e) => a.search(e.slice(0, 300).trim())[0] || { score: 1 })
              .map((e) => e.score);
          },
          (e, t) => ({ didFirstWin: e < t, tie: e === t }),
        );
      ...
      compute() {
        return r(this.compareData(), this.compareFunction()).map(
          (e) => this.data[e.index],
        );
      }
    }
    const r = (e, t) =>
      e
        ...
        .sort((e, n) => t(e.item, n.item) || e.index - n.index)
        .map(({ item: e }) => e);
  },
  221: function (e, t, n) {
    "use strict";
    ...
    class a {
      constructor(e, t, n) {
        ...
        ((o = async () => {
          ...
          return (
            this.active && t && this.watchPreviewUpdates(),
            { isActive: this.active, initialRef: e.ref, upToDate: t }
          );
        }),
          (r = "setup") in (i = this)
      ...
      async updatePreview() {
        ...
        (this.start(t),
          e &&
            Object(i.dispatchToolbarEvent)(i.toolbarEvents.previewUpdate, {
              ref: t,
            }) &&
            (this.cancelPreviewUpdates(), Object(r.b)()));
      }
      async start(e) {
        return e
          ? e === this.cookie.getRefForDomain()
            ? { displayPreview: !0, shouldReload: !1 }
            : (this.cookie.upsertPreviewForDomain(e),
              { displayPreview: !1, shouldReload: !0 })
          : (await this.end(), { displayPreview: !1, shouldReload: !1 });
      }
      async end() {
        (this.cancelPreviewUpdates(),
          await this.client.closePreviewSession(),
          this.cookie.deletePreviewForDomain(),
          Object(i.dispatchToolbarEvent)(i.toolbarEvents.previewEnd) &&
            Object(r.b)());
      }
      async share() {
  ...
  222: function (e, t, n) {
    ...
    t.a = async () => {
      ...
      (document
        ...
        .setAttribute("data-html2canvas-ignore", !0),
        i ||
          ((e = "https://html2canvas.hertzen.com/dist/html2canvas.min.js"),
          (i = new Promise((t) => {
      ...
      try {
        ...
        return new Promise((t) => e.toBlob(t, "image/jpeg", 0.6));
      } catch (e) {
        console.warn("Caught html2canvas error", e);
        const t = document.createElement("canvas");
        return new Promise((e) => t.toBlob(e, "image/jpeg", 0.6));
      }
    };
  },
  223: function (e, t, n) {
    ...
    class o {
      constructor(e, t) {
        (r(
          ...
          "buildApiEndpoint",
          () =>
            (this.client.hostname.includes(".test") ? "http" : "https") +
            "://" +
          ...
          r(this, "start", async (e) => {
            (this.dispatchLoading(), await Object(i.wait)(2));
            const t = e || this.cookie.getTracker();
            (await this.predict(t), this.cookie.refreshTracker());
          }),
          r(
            this,
            "predict",
  ...
  224: function (e, t, n) {
    ...
    class r {
      constructor(e) {
        (i(this, "trackDocumentClick", (e) =>
          this.client.trackDocumentClick(e),
        ),
  ...
  225: function (e, t, n) {
    ...
    class o {
      constructor(e, t) {
        ((this.isAuthenticated = e), (this.domain = t));
      }
      init(e) {
        if (this.makeConvertLegacy()) return { convertedLegacy: !0 };
        const t = (() => {
            const e = this.get();
            return e && e._tracker;
          })(),
          n = this.build({ tracker: t, preview: e });
        return (this.set(n), { convertedLegacy: !1 });
      }
      makeConvertLegacy() {
      ...
      set(e) {
        e
          ? Object(i.setCookie)("io.prismic.preview", e)
          : Object(i.demolishCookie)("io.prismic.preview");
      }
      build({ preview: e, tracker: t } = { preview: null, tracker: null }) {
        const n = (() => {
            if (e)
              return Object(i.isObject)(e)
                ? e
                : { [this.domain]: { preview: e } };
          })(),
          r = (() => {
            if (this.isAuthenticated && t)
              return { _tracker: t || this.generateTracker() };
          })();
        if (n || r) return Object.assign({}, r || {}, n || {});
      }
      convertLegacyCookie(e) {
        const t = this.build({ tracker: this.generateTracker(), preview: e });
        return (this.set(t), t);
      }
      generateTracker() {
        return Object(r.p)(8);
      ...
      getRefForDomain() {
        const e = this.get();
        if (e) return e[this.domain] && e[this.domain].preview;
      }
      getTracker() {
        const e = this.get();
        if (e) return e._tracker;
      }
      refreshTracker() {
        const e = this.getRefForDomain(),
          t = this.build({ preview: e, tracker: this.generateTracker() });
        this.set(t);
      }
    }
  },
  ...
  https://prismic.io/docs/javascript/beyond-the-api/in-website-preview`;
      window.prismic = window.PrismicToolbar = {
        ...
        version: "4.1.2",
        setup: (...t) => {
          (e`window.prismic.setup is deprecated.`, t.forEach(d));
        },
        startExperiment: (e) => {
      ...
      const l = new URL(
        Object(o.a)(document.currentScript.getAttribute("src")),
      ...
      (p && (e`window.prismic.endpoint is deprecated.`, t.add(p)),
        t.size || e`Your are not connected to a repository.`);
      let h = null;
      async function d(t) {
        const n = (function (e) {
          if (!e) return null;
          if (!/^(https?:\/\/)?[-a-zA-Z0-9.\/]+/.test(e)) return null;
    ...
    Already connected to a repository (${h}).`;
        ...
        const d = n.match(".test$") ? window.location.protocol : "https:",
          l = await i.a.getClient(
            `${d}//${n}/prismic-toolbar/4.1.2/iframe.html`,
          ),
          p = await l.getPreviewState(),
          m = new u.a(p.auth, l.hostname),
          f = new a.a(l, m, p),
          w = p.auth && new s.a(l, m),
          v = p.auth && new c.a(l),
          { initialRef: g, upToDate: b, isActive: y } = await f.setup(),
          { convertedLegacy: k } = m.init(g);
        !k && b
          ? ((y || p.auth) &&
              (await Object(r.script)(
                "https://prismic.io/prismic-toolbar/4.1.2/toolbar.js",
              ),
            ...
            y ||
              (m.getRefForDomain() && m.deletePreviewForDomain(),
              await l.closePreviewSession()))
          : Object(o.b)();
      }
      t.forEach(d);
    }
  ...
  232: function (e, t) {
    ...
    if (n || i) throw new Error("Prismic does not support Internet Explorer.");
  },
  233: function (e, t, n) {
    "use strict";
    (n.r(t),
    ...
    class a {
      constructor(e) {
        ((this.cookie = new r.a()), (this.expId = e), this.setup());
      }
      async setup() {
        Object(i.disabledCookies)() ||
          (await Object(i.script)(
            `//www.google-analytics.com/cx/api.js?experiment=${this.expId}`,
          ),
          (this.variation = window.cxApi.chooseVariation()),
          this.variation === window.cxApi.NOT_PARTICIPATING
            ? this.end()
            : this.start());
      }
      async start() {
        ...
        const e = this.cookie.get();
        (this.cookie.delete(), this.cookie.get() !== e && Object(o.b)());
      }
    }
  },
  3: function (e, t, n) {
    ...
    const i = { SetupPort: "setup_port", Ready: "ready" },
      r = {
  ...
  31: function (e, t, n) {
    ...
    async function r(e) {
      return (
        await fetch(`/toolbar/trackDocumentClick?isMain=${Boolean(e)}`),
        null
      );
    }
    async function o() {
      ...
      if (Object(i.getCookie)("is-logged-in") && !e.get())
        return (await fetch("/toolbar/trackToolbarSetup"), e.set(!0), null);
    }
  },
  45: function (e, t, n) {
    "use strict";
    ...
    const s = {
        async get(e) {
          ...
          t.appendChild(n);
          const a = await Object(i.a)(n, "load", () => n),
            c = await s.establishConnection(a);
          return new r.a(c, o);
        },
        buildIframe(e) {
          ...
          new Promise((t) => {
            ...
            if (
              ((n.onmessage = (e) => {
                if (e.data !== a.b.Ready)
                  throw new Error(
                    `Unexpected message received before iframe ready: ${e.data}`,
                  );
                t(n);
              }),
              !e.contentWindow)
            ...
            e.contentWindow.postMessage(a.b.SetupPort, "*", [i]);
          }),
      },
      c = {
        ...
        async setup() {
          ((c.initializationDelayed = !1),
            ...
            window.addEventListener("message", (e) =>
              c.initialisationMessageHandler(e),
            ));
        },
        initialisationMessageHandler(e) {
          if (e.data === a.b.SetupPort) {
            ((c.initialized = !0),
    ...
    class r {
      ...
      _messageToPromise(e, t) {
        return new Promise((n) => {
          (this.events.addEventListener(e, (e) => n(e.detail), { once: !0 }),
            this.port.postMessage({ type: e, data: t }));
        });
      }
      getPreviewState() {
    ...
    function c(e) {
      e.onmessage = async (t) => {
        const { type: n, data: c } = t.data,
          u = await (() => {
            switch (n) {
              case s.a.PreviewState:
                return (async function () {
                  return o.a.getState();
                })();
              case s.a.PredictionDocs:
                return (async function (e) {
                  return i.a(e);
                })(c);
              case s.a.DevModeQueriesResults:
                return (async function ({ tracker: e }) {
                  return r.a(e);
                })(c);
              case s.a.UpdatePreview:
                return (async function () {
                  return o.a.getCurrentRef();
                })();
              case s.a.ClosePreviewSession:
                return (async function () {
                  return o.a.close();
                })();
              case s.a.SharePreview:
                return (async function ({ location: e, blob: t }) {
                  return o.a.share(e, t);
                })(c);
              case s.a.TrackDocumentClick:
                return (async function ({ isMain: e }) {
                  return a.a(e);
                })(c);
              case s.a.TrackToolbarSetup:
                return (async function () {
                  return a.b();
                })();
              default:
  ...
  49: function (e, t, n) {
    ...
    async function r({ url: e, ref: t, tracker: n, location: r }) {
      const a = await Object(i.fetchy)({
        url: `/toolbar/predict?${Object(i.query)({ url: e, ref: t, tracker: n })}`,
      }).then((e) => e.documents.map(o));
      return new i.Sorter(a)
        .max((e) => e.updated)
        .min((e) => e.queryTotal)
        .is((e) => e.uid && r.hash.match(e.uid))
        .is((e) => e.uid && r.search.match(e.uid))
        .is((e) => e.uid && r.pathname.match(e.uid))
        .min((e) => e.urls.length)
        .min((e) => e.weight)
        .is((e) => e.singleton)
        .is((e) => e.uid && r.hash.match(e.uid) && !e.singleton)
        .is((e) => e.uid && r.search.match(e.uid) && !e.singleton)
        .is((e) => e.uid && r.pathname.match(e.uid) && !e.singleton)
        .compute();
    }
    function o(e) {
      const t = e.editorUrl.includes("c=unclassified")
        ? "draft"
        : e.editorUrl.includes("c=release")
          ? "release"
          : e.editorUrl.includes("c=variation")
            ? "experiment"
            : e.editorUrl.includes("c=published")
              ? "live"
              : null;
      return {
        ...e,
  ...
  50: function (e, t, n) {
    "use strict";
    function i(e) {
      return fetch(`/toolbar/devMode?tracker=${e}`).then((e) =>
        200 === e.status ? e.json() : [],
      );
    }
    n.d(t, "a", function () {
  ...
  8: function (e, t, n) {
    ...
    function a(e, t, n = 1 / 0) {
      return r.a.set(e, t, { path: "/", expires: n, sameSite: "lax" });
    }
    function s(e) {
      r.a.remove(e, { path: "/" });
    }
    function c(e, t) {
      const n = window.location.hostname.split("."),
        ...
        o = []
          .concat(n.map((e, t) => `${n.slice(t).join(".")}`))
          .concat(n.map((e, t) => `.${n.slice(t).join(".")}`))
          .concat(null),
        a = []
          .concat(i.map((e, t) => `/${i.slice(0, t + 1).join("/")}`))
          .concat(i.map((e, t) => `/${i.slice(0, t + 1).join("/")}/`))
          .concat("/")
          .concat(null);
      o.forEach((n) =>
        a.forEach((i) => r.a.remove(e, { ...t, domain: n, path: i })),
      );
    }
  },
  9: function (e, t, n) {
