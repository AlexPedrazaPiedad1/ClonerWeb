 ...
 */ var rt = {
  ...
  si = function (t) {
    ...
    for (r = t.length; r--; )
      (t[r] && (t[r]._gsap || (t[r]._gsap = new cr(t[r], i)))) ||
        t.splice(r, 1);
    return t;
  },
  zt = function (t) {
  ...
  lt = function (t, e, i, r) {
    return (
      e.parent && Ot(e),
      (e._start = V(
        (yt(i) ? i : i || t !== z ? at(t, i, e) : t._time) + e._delay,
      )),
      (e._end = V(
  ...
  ue = function (t) {
    for (var e = 0, i = "", r, n, s, a; ~(r = t.indexOf("random(", e)); )
      ((s = t.indexOf(")", r)),
        ...
        (i +=
          t.substr(e, r - e) + ir(a ? n : +n[0], a ? 0 : +n[1], +n[2] || 1e-5)),
        (e = s + 1));
  ...
  fn = function (t) {
    ...
    return i && e.length > 1 && i.config
      ? i.config.apply(
          null,
          ~t.indexOf("{") ? [on(e[1])] : un(t).split(",").map(Gi),
        )
      : S._CE && sn.test(t)
        ? S._CE("", t)
        : i;
    ...
    if (
      ...
      return !isNaN(c * r) && r !== ""
        ? ((p = new j(
          ...
          (this._pt = p))
        : (!l && !(e in t) && ii(e, r),
          hn.call(this, t, e, c, r, d, o || rt.stringFilter, f));
  },
  _n = function (t, e, i, r, n) {
    if (
      (L(t) && (t = se(t, n, e, i, r)),
      !dt(t) || (t.style && t.nodeType) || $(t) || Li(t))
    )
      ...
      for (
        ...
        if (
          ...
          D &&
            ...
            ((t._pt = O =
              new j(t._pt, b, A.name, 0, 1, A.render, A, 0, A.priority)),
          ...
          for (P in g)
            tt[P] && (A = dr(P, g, t, U, b, x))
              ? A.priority && (k = 1)
              : (q[P] = O =
                  oi.call(t, b, P, "get", g[P], U, x, 0, r.stringFilter));
        ...
        if (((c = l), (v = this.timeline), this._repeat)) {
          ...
          p !== m &&
            ...
            this.vars.repeatRefresh &&
              ...
              this._initted &&
              ((this._lock = s = 1),
              (this.render(V(_ * p), !0).invalidate()._lock = 0)));
        }
        if (!this._initted) {
 ...
 */ var Pi,
  ...
  Un = function (t, e, i, r) {
    if (!i || i === "none") {
      ...
      s && s !== i
        ? ((e = n), (i = s))
        : e === "borderColor" && (i = ft(t, "borderTopColor"));
    }
    ...
    if (
      ...
      (r += ""),
      r.substring(0, 6) === "var(--" &&
        (r = ft(t, r.substring(4, r.indexOf(")")))),
      r === "auto" &&
        ((_ = t.style[e]),
        (t.style[e] = r),
        (r = ft(t, e) || r),
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if (n === "all" || n === !0) ((r.cssText = ""), (o = 1));
        ...
        for (n = n.split(","), f = n.length; --f > -1; )
          ((a = n[f]),
            xt[a] && ((o = 1), (a = a === "transformOrigin" ? H : F)),
            Nt(i, a));
      o &&
        (Nt(i, F),
        s &&
        ...
        if (
          ...
          if (
            ...
            if (
              ...
              d === "string" &&
                h.substring(0, 6) === "var(--" &&
                ((h = ft(t, h.substring(4, h.indexOf(")")))),
                (l = parseFloat(h))),
              T ||
                ((g = t._gsap),
                ...
                (T = this._pt =
                  new j(this._pt, a, F, 0, 1, g.renderTransform, g, 0, -1)),
                (T.dep = 1)),
              _ === "scale")
            )
              ((this._pt = new j(
