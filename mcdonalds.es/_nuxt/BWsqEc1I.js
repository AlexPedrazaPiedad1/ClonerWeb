  ...
  Le = {
    ...
    sc: Zr(function (o) {
      return arguments.length
        ? Ve.scrollTo(o, ae.sc())
        : Ve.pageXOffset || Dt[Ar] || Rt[Ar] || nr[Ar] || 0;
    }),
  },
  ae = {
    s: Or,
    ...
    sc: Zr(function (o) {
      return arguments.length
        ? Ve.scrollTo(Le.sc(), o)
        : Ve.pageYOffset || Dt[Or] || Rt[Or] || nr[Or] || 0;
    }),
  },
  Be = function (e, n) {
    return (
    ...
    (e.init = function (t) {
      ...
      var Ct,
        ...
        Zt = function (m, F) {
          (Me &&
            !Ne &&
            ((a.axis = Ne = Math.abs(m) > Math.abs(F) ? "x" : "y"), (Xe = !0)),
            Ne !== "y" && ((et[2] += m), a._vx.update(m, !0)),
            Ne !== "x" && ((Ze[2] += F), a._vy.update(F, !0)),
            x ? Ct || (Ct = requestAnimationFrame(vt)) : vt());
        },
        Et = function (m) {
          if (!te(m, 1)) {
            ...
            ((a.x = F),
              ...
              (C ||
                ...
                ((ze = C ? 2 : 1), C || (a.isDragging = !0), Zt(b, _)));
          }
        },
      ...
      ((De = a._dc = ve.delayedCall(h || 0.25, Mr).pause()),
        (a.deltaX = a.deltaY = 0),
        (a._vx = dn(0, 50, !0)),
        (a._vy = dn(0, 50, !0)),
        (a.scrollX = U),
        ...
        (a.disable = function () {
          a.isEnabled &&
            (rr.filter(function (S) {
              return S !== a && wr(S.target);
            }).length || Re(Tt ? K : l, "scroll", pn),
            a.isPressed &&
              (a._vx.reset(), a._vy.reset(), Re(Q ? l : K, ot[1], Et, !0)),
 ...
 */ var d,
  ...
  Yn = function (e, n) {
    return n && (!$e(e) || e.substr(0, 6) !== "clamp(")
      ? "clamp(" + e + ")"
      : e;
  },
  bi = function o() {
  ...
  Ci = function (e, n, t) {
    var r = t.d,
      i = t.d2,
      u = t.a;
    return (u = At(e, "getBoundingClientRect"))
      ? function () {
          return u()[r];
        }
      : function () {
  ...
  Br = function (e, n, t, r, i, u, l, p) {
    ...
    return (
      (k += "position:" + ((X || p) && $ ? "fixed;" : "absolute;")),
      (X || p || !$) &&
        (k += (r === ae ? Sn : kn) + ":" + (u + parseFloat(h)) + "px;"),
      l &&
        (k +=
  ...
  jt = function () {
    (!Oe || !Oe.isPressed || Oe.startX > L.clientWidth) &&
      (P.cache++,
    ...
    (P.cache++,
      (e === !0 ||
        (!Ce &&
          ...
          (!hn ||
            ii !== E.innerWidth ||
            Math.abs(E.innerHeight - ni) > E.innerHeight * 0.25))) &&
        Jr.restart(!0));
  },
  Vt = {},
  Pi = [],
  ...
  yt = function (e) {
    if (e === 2 || (!Fe && !Qr)) {
      ...
      if (
        ...
        Fe || (xn = i),
        r &&
          (je && !tn && t - je > 200 && ((je = 0), qt("scrollEnd")),
          (dr = sn),
          (sn = t)),
        Vr < 0)
      ) {
        ...
        Vr = 1;
      } else for (Ye = 0; Ye < n; Ye++) T[Ye] && T[Ye].update(0, r);
      R.isUpdating = !1;
    }
    Pr = 0;
  },
    ...
    if ((v && ((p[v] = e || -0.001), e < 0 && (e = 0)), u)) {
      ...
      ((X = "scroll" + r.d2),
        Ur(
          ...
          r,
          (Ie && Te > 20) ||
            (!Ie && (M ? Math.max(L[X], Ue[X]) : u.parentNode[X]) <= Te + 1),
        ),
        M &&
          ((x = xt(l)),
  ...
  R = (function () {
    ...
    return (
      (e.init = function (t, r) {
        ...
        if (
          ...
          "refreshPriority" in t &&
            ((ti = 1), t.refreshPriority === -9999 && (Tr = s)),
          ...
          r &&
            ...
            p || (p = r.vars.id)),
          k &&
            ((!Nt(k) || k.push) && (k = { snapTo: k }),
            "scrollBehavior" in L.style &&
              d.set(ie ? [L, Ue] : w, { scrollBehavior: "auto" }),
            P.forEach(function (f) {
              return (
                ke(f) &&
                f.target === (ie ? B.scrollingElement || Ue : w) &&
                (f.smooth = !1)
              );
            }),
            (Ct = ke(k.snapTo)
                ...
                : k.snapTo === "labelsDirectional"
                  ...
                  : k.directional !== !1
                    ? function (f, b) {
                        return En(k.snapTo)(
                          f,
                          Se() - dt < 500 ? 0 : b.direction,
                        );
                      }
                    : d.utils.snap(k.snapTo)),
            (tt = k.duration || { min: 0.1, max: 2 }),
            (tt = Nt(tt) ? yr(tt.min, tt.max) : yr(tt, tt)),
            (rt = d
              .delayedCall(k.delay || It / 2 || 0.1, function () {
                var f = ee(),
                  b = Se() - dt < 500,
                  _ = Me.tween;
                if (
                  ...
                  var C = (f - O) / U,
                    ...
                    Z = d.utils.clamp(-C, 1 - C, (Qt(A / 2) * A) / 0.185),
                    ...
                    (k.inertia === !1 && (Z = V - C),
                      Me(
                        H,
                        {
                          duration: tt(
                            Qt(
                              (Math.max(Qt(we - fe), Qt(V - fe)) * 0.185) /
                                A /
                                0.05 || 0,
                            ),
                          ),
        ...
        if (
          ...
          (s.revert = function (f, b) {
            ...
            _ !== s.isReverted &&
              (_ &&
                ...
                (zt = r && r.progress())),
              Xe &&
                [Xe, Ne, a, He].forEach(function (fe) {
                  return (fe.style.display = _ ? "none" : "block");
                }),
              _ && ((Ce = s), s.update(_)),
              c &&
                (!qe || !s.isActive) &&
                (_ ? Di(c, ce, ht) : un(c, ce, Qe(c), te)),
              _ || s.update(_),
              (Ce = C),
              (s.isReverted = _));
          }),
          (s.refresh = function (f, b, _, C) {
            if (!((Ce || !s.enabled) && !b)) {
              ...
              (!Fe && oe && oe(s),
                (Ce = s),
                Me.tween && !_ && (Me.tween.kill(), (Me.tween = 0)),
                D && D.pause(),
                $ &&
                  r &&
              ...
              for (
                Q &&
                Nt(_) &&
                ((cr = d.getProperty(a, g.p)), (Rr = d.getProperty(He, g.p)));
                he-- > 0;
              )
                ((se = T[he]),
                  ...
                  lt &&
                    (lt === h || lt === c || lt === We) &&
                    !se.isReverted &&
                    (ur || (ur = []), ur.unshift(se), se.revert(!0, !0)),
                  se !== T[he] && (st--, he--));
              for (
                ke(G) && (G = G(s)),
                  G = On(G, "start", s),
                ...
                ((se = T[he]),
                  ...
                  lt &&
                    ...
                    ((lt === h && se.start - se._pinPush < O) || lt === We) &&
                      isNaN(G) &&
                      (V += _e * (1 - se.progress)),
                    lt === c && (H += _e)));
              if (
                ...
                s._endClamp &&
                  !Fe &&
                  ((s._endClamp = q || -0.001), (q = Math.min(q, ct(w, g)))),
                (U = q - O || ((O -= 0.01) && 0.001)),
                ...
                ((_e = Qe(c)),
                  ...
                  !Z &&
                    q > 1 &&
                    ((at = (ie ? B.scrollingElement || Ue : w).style),
                    (at = {
                      style: at,
                ...
                for (ye = h.parentNode; ye && ye !== L; )
                  (ye._pinOffset &&
                    ((O -= ye._pinOffset), (q -= ye._pinOffset)),
                    (ye = ye.parentNode));
              (ur &&
                ur.forEach(function (Pt) {
                ...
                (we || me !== s.progress || y || $ || (r && !r._initted)) &&
                  (r &&
                    !ue &&
                    (r._initted || me || r.vars.immediateRender !== !1) &&
                    r.totalProgress(
                      y && O < -0.001 && !me ? d.utils.normalize(O, q, 0) : me,
                      !0,
                    ),
          ...
          (s.labelToScroll = function (f) {
            return (
              (r &&
                r.labels &&
                (O || s.refresh() || O) + (r.labels[f] / r.duration()) * U) ||
              0
            );
          }),
            ...
            if (!(y && !_ && !f)) {
              ...
              if (
                (b &&
                  ((ze = De),
                  (De = y ? ee() : C),
                  k && ((Lt = Et), (Et = r && !ue ? r.totalProgress() : A))),
                X &&
                  c &&
                  !Ce &&
                  !Fr &&
                ...
                if (
                  ...
                  it &&
                    ...
                    ue &&
                      ((z = (!G && I[H + 1] !== "none" && I[H + 1]) || I[H]),
                      (st =
                        r && (z === "complete" || z === "reset" || z in r)))),
                  Ie &&
                    (G || st) &&
                    (st || M || !r) &&
                    (ke(Ie)
                      ? Ie(s)
                      : s.getTrailing(Ie).forEach(function (Xt) {
                ...
                (k && !Me.tween && !Ce && !Fr && rt.restart(!0),
                  l &&
                    (G || (ge && A && (A < 1 || !on))) &&
                    Er(l.targets).forEach(function (Xt) {
                      return Xt.classList[we || ge ? "add" : "remove"](
                        l.className,
                      );
                    }),
                  u && !ue && !f && u(s),
                  it && !Ce
                    ? (ue &&
                      ...
                      (G || !on) &&
                        ...
                        G || ((H = A === 1 ? 1 : 3), Pe[H] && ln(s, Pe[H]))),
                      Te &&
                        !we &&
                        Math.abs(s.getVelocity()) > (_r(Te) ? Te : 2500) &&
                        (pr(s.callbackAnimation),
                        D ? D.progress(1) : pr(r, z === "reverse" ? 1 : !A, 1)))
                    : ue && u && !Ce && u(s));
              }
              if (Kt) {
          ...
          (s.enable = function (f, b) {
            s.enabled ||
              ...
              f !== !1 && ((s.progress = me = 0), (De = ze = Ke = ee())),
              b !== !1 && s.refresh());
          }),
          ...
          (s.disable = function (f, b) {
            if (
              ...
              rt && (rt.pause(), Me.tween && Me.tween.kill() && (Me.tween = 0)),
              !ie)
            ) {
      ...
      (o.register = function (t) {
        return (
          er ||
            ((d = t || si()), oi() && window.document && o.enable(), (er = gr)),
          er
        );
      }),
      ...
      (o.disable = function (t, r) {
        ...
        for (var i = 0; i < P.length; i += 3)
          (zr(pe, P[i], P[i + 1]), zr(pe, P[i], P[i + 2]));
      }),
      (o.enable = function () {
        if (
          ((E = window),
          ...
          ((gr = 1),
            ...
            (o.isTouch = J.isTouch),
            (Mt =
              J.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent)),
            (hn = J.isTouch === 1),
            de(E, "wheel", jt),
            (yn = [E, B, Ue, L]),
            d.matchMedia
          ...
          for (
            ...
            (zr(pe, P[p], P[p + 1]), zr(pe, P[p], P[p + 2]));
        }
      }),
      (o.config = function (t) {
        ...
        ((r && clearInterval(Yr)) || ((Yr = r) && setInterval(Xn, r)),
          ...
          "autoRefreshEvents" in t &&
            (Lr(pe) || Lr(de, t.autoRefreshEvents || "none"),
...
R.batch = function (o, e) {
  ...
  for (l in e)
    t[l] =
      l.substr(0, 2) === "on" && ke(e[l]) && l !== "onRefreshInit"
        ? u(l, e[l])
        : e[l];
  return (
    ke(i) &&
    ...
    if (!u._isScrollT || l - u._isScrollT > 2e3) {
      for (
        ...
        ((i.scrollHeight <= i.clientHeight && i.scrollWidth <= i.clientWidth) ||
          !(Wr[(p = Qe(i)).overflowY] || Wr[p.overflowX]));
      )
        i = i.parentNode;
      ((u._isScroll =
        i &&
    ...
    var n = e,
      ...
      Pe = function () {
        (Ie(),
          w.isActive() &&
            w.vars.scrollY > p &&
            (c() > p ? w.progress(1) && c(p) : w.resetTo("scrollY", p)));
      };
    return (
      h && d.set(h, { y: "+=0" }),
      (e.ignoreCheck = function (I) {
        return (
          (Mt && I.type === "touchmove" && ue()) ||
          ($ > 1.05 && I.type !== "touchstart") ||
          l.isGesturing ||
      ...
      (e.onRelease = e.onGestureStart =
        function (I, Q) {
          if ((c.offset && g(), !Q)) Ee.restart(!0);
            ...
            (t &&
              ((s = v()),
              (oe = s + (j * 0.05 * -I.velocityX) / 0.227),
              (j *= $n(v, s, oe, ct(x, Le))),
              (w.vars.scrollX = y(oe))),
              (s = c()),
              (oe = s + (j * 0.05 * -I.velocityY) / 0.227),
              (j *= $n(c, s, oe, ct(x, ae))),
              (w.vars.scrollY = Te(oe)),
              w.invalidate().duration(j).play(0.01),
              ((Mt && w.vars.scrollY >= p) || s >= p - 1) &&
                d.to({}, { onUpdate: Pe, duration: j }));
          }
          u && u(I);
        }),
      (e.onWheel = function () {
